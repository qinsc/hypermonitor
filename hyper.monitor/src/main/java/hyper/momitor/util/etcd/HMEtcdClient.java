...
/** The Etcd client API. */
public interface HMEtcdClient {
  /**
   * @return Version of the etcd instance
   * @throws HMEtcdException in case of an error
   */
  String version() throws HMEtcdException;
   ...
   * @throws HMEtcdException in case of an error (e.g. key doesn't exist)
   */
  String get(String key) throws HMEtcdException;
   ...
   * @throws HMEtcdException in case of an error
   */
  void set(String key, String value) throws HMEtcdException;
   ...
   * @throws HMEtcdException in case of an error
   */
  void set(String key, String value, int ttl) throws HMEtcdException;
   ...
   * @throws HMEtcdException in case of an error
   */
  void delete(String key) throws HMEtcdException;
   ...
   * @throws HMEtcdException in case of an error
   */
  Map<String, String> list(String path) throws HMEtcdException;
